...
def GetSingleTweetByUrl(_url):
    ...
    result['urls'] = GetListUrlByGoogleKeywordSearch(tweet_text)
...
def GetListUrlByGoogleKeywordSearch(_key_word):
    ...
    exclude_site = " -site:twitter.com -site:facebook.com -site:google.com"
    url = url_pre + _key_word + exclude_site + "&num=10"
